...
const AddView = {
  ...
  bindMapClick(callback) {
    ...
    const mapTilerLayer = L.tileLayer('https://api.maptiler.com/maps/streets-v2/256/{z}/{x}/{y}.png?key=g8oK19blBXwfNG5EWWeA', {
      attribution: '&copy; MapTiler & OpenStreetMap contributors'
    });

    const satelliteLayer = L.tileLayer('https://api.maptiler.com/maps/hybrid/256/{z}/{x}/{y}.jpg?key=g8oK19blBXwfNG5EWWeA', {
      attribution: '&copy; MapTiler & OpenStreetMap contributors'
    });
